...
export const ttIcons: IconMatcher[] = [
  ...
  { pattern: ['GS Access Key'], emoji: 'tt_gsaccesskey' },
  ...
  {
    pattern: [
      'Progressive Gardening Kit',
      'Progressive Watering Can',
    ],
    emoji: 'tt_gardeningkit',
  },
  { pattern: ['Progressive Shovel'], emoji: 'tt_shovel' },
  { pattern: ['Missing Cattlelog'], emoji: 'tt_cattlelog' },
